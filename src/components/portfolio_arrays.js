...
export const descriptionArray = [
  ...
  'Parks2Go is an app that provides information on State Parks around the country. The apps mission is to facilitate park information to make trips as seamless as possible. Adventurers will love the app as individual state parks can be narrowed down by outdoor activities. Users can choose from a variety of activities from kayaking to site seeing. These family friendly trails are the most beautiful of the country and are worth exploring.  The home page will provide users with an interactive USA map. Each state will pull information on the different state parks and will have the opportunity to filter by outdoor activities. Once a park is chosen the app will display Park ideas, Description, Images, Activities, Topics, and Directions. The user will also have the option to choose another park from a horizontal gallery that is displayed at the bottom of the page. The footer will include a link to the About Us page, links to the state parks page of each state and connect with social media icons. Parks2Go acquires park information from different API pulls from https://nps.gov/. This information will fit into the different areas of the park text that is displayed for Park details, Description, Images, Activities, Topics, and Directions. For this application, I will develop 4 pages; Home, State Parks, Park, and About Us. I will be using React to create an interactive UI design. I will be dividing the application into different components for content, styling, functionality, and validation. Parks2Go will be accessible for multiple device sizes. It will be designed with the mobile first approach and then work its way up in size. Once the website is running the site will be tested in multiple browsers, to provide the user with a seamless user experience.',
  ' ',
  'PayItForward is a resource site for faithful ministries to use, as another form of steward outreach. The app is meant to be used by ministry members; in order, to provide a safe environment for both the recipient and the donor. The steward providing the service must go through a background check with fingerprints identification, prior to volunteering; organized by the church who is supplying the service. The site is meant as a form of communication, for services that are in need of care. Recipients can make an appointment for a "faithful steward" via the app or computer. They are then matched with a volunteer, who can run errands, drive to the doctor, watch movies, chat, build, fix, do handywork, garden, paint, mechanics, etc.  ( a small fee may be included for their services). The volunteers do not provide any personal care, like bathing or grooming. They are also not a pick-up or drop-off service, like Uber or Lyft. PayItForward is meant for anyone who needs to get a project or task completed, with the help of a volunteer or at a fraction of the cost. This app will be used by active church members, whose faith are believers of God; whom are part of an active congregation community. Both men or woman within the ages of 30 - 65+, who are either single parents, divorcees, elderly couple, or widowers. They live in a suburban area; whose education is of all levels. Participants earnings are between 30k - 70K. They are either employed full-time or retired. They come from any cultural background and are usually weekend warriors, do it yourselfers, people who cant afford caregivers or contractors, elderly men who cannot undertake big projects, or individuals who need some company. There are some volunteer software’s that provide church ministries a scheduler type system that can keep track of events and volunteers. There are also volunteer applications that offer seniors the opportunity to connect with student volunteers in their area, at a reasonable price/ hour. However, there is none that I found that will connect members with members within the same religious institution. I consider this be a major difference. The app will help further spread the opportunity to fellowship, within the community of servers; connecting the right volunteer to the right service. By working within a same community of faithful’s; not only does stewardship become more convenient for beginner servers whom may not know how to start servicing, but in large church communities where not everyone may know each other, the app can help bring people together.',
  ' ',
  ' ',
];
...
export const lofiDArray = [
  ...
  './images/p2go__lofi_desktop.png',
  ' ',
  './images/PIF__lofi_desktop.png',
  ' ',
  ' ',
];
export const lofiMArray = [
  './images/FSP_lofi_mobile.png',
  './images/p2go__lofi_mobile.png',
  ' ',
  './images/PIF__lofi_mobile.png',
  ' ',
  ' ',
];
export const hifiDArray = [
  './images/FSP_hifi_desktop.png',
  './images/p2go__hifi_desktop.png',
  ' ',
  './images/PIF__hifi_desktop.png',
  ' ',
  ' ',
];
export const hifiMArray = [
  './images/FSP_hifi_mobile.png',
  './images/p2go__hifi_mobile.png',
  ' ',
  './images/PIF__hifi_mobile.png',
  ' ',
  ' ',
];
