...
export const descriptionArray = [
  ...
  'Music & Supplies Contact Form is an HTML project using pur vanilla JavaScript',
  ...
  'Post It is a React application, implementing local storage and restful API usage.',
  'Fearless Buffet Task Manager is a Glitch application using HTML5 and Sass Style Sheets',
];
